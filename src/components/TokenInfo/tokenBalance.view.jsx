      ...
      <div className="row">
        {data.exchangeBalance ? Object.keys(data.exchangeBalance).map((exchangeName, i) =>
          <div className="col-4 col-sm-3 col-md" key={i}>
            ...
            <div className="h6 font-weight-sbold">{data.exchangeBalance[exchangeName].AvailableBalance + data.exchangeBalance[exchangeName].DepositBalance + data.exchangeBalance[exchangeName].LockedBalance}</div>
          </div>
        ) : <div></div>}
      </div>
    </div>
